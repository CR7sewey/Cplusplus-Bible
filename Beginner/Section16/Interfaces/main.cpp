...
class Checking: public Account  {
    friend std::ostream &operator<<(std::ostream &os, const Checking &acc); // not inherited
public:
    virtual void withdraw(double amount) {
...
int main() {
    ...
    std::cout << *p2<< std::endl; // pprints Account bcs there is no virtual funtion dealing with << operaations!
