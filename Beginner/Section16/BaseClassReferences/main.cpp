...
void do_withdraw(Account &account, double amount) {
    account.withdraw(amount); // bound dyn. - virtual func
}
...
int main() {
    ...
    Account a;
    Account &ref = a;
    ref.withdraw(1000);		    // In Account::withdraw - biinding dynamically

    Trust t;
    Account &ref1 = t;
    ref1.withdraw(1000);        // In Trust::withdraw - bound dyn.
